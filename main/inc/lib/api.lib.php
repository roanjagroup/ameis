...
function api_format_course_array($course_data)
{
    ...
    if (file_exists(api_get_path(SYS_COURSE_PATH).$course_data['directory'].'/course-pic-md.png')) {
        $url_image = api_get_path(WEB_COURSE_PATH).$course_data['directory'].'/course-pic-md.png';
    } else {
