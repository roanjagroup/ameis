...
if (is_int($global_error_code) && $global_error_code > 0) {
     ...
     */
    $theme_user = 'ameis';
    $css_base_file_theme = $css_web_path.'themes/'.$theme_user.'/default.css';


    $css_list = array($bootstrap_file, $css_base_file, $themePath, $css_base_file_theme);
     ...
     * @author Roanja <info@roanja.com> Cleaning code
     */
    $global_error_message['user_logo'] = "data:image/png;base64,".base64_encode(file_get_contents($root_sys.'web/css/themes/'.$theme_user.'/images/header-logo-custom1.png'));
...
<<<EOM
    ...
    <!DOCTYPE html>
        ...
        <body class="nav-md">        
            <div id="page-error" class="container body">
